...
<link rel="stylesheet" type="text/css" href="../webcam/jpeg_camera/css/bootstrap.min.css" >
<link rel="stylesheet" type="text/css" href="../webcam/jpeg_camera/css/cropper.css">
<link rel="stylesheet" type="text/css" href="../webcam/jpeg_camera/css/layout.css">
<link rel="stylesheet" type="text/css" href="../webcam/jpeg_camera/css/font-awesome.min.css">
...
<script type="text/javascript" src="../webcam/jpeg_camera/jquery-1.12.1.min.js" ></script>
<script type="text/javascript" src="../webcam/jpeg_camera/webcam.min.js" ></script>
<script type="text/javascript" src="../webcam/jpeg_camera/js/cropper.js" ></script>
<script type="text/javascript" src="../webcam/jpeg_camera/js/bootstrap.min.js"></script>
...
<table cellspacing='0' cellpadding='0' border='0' class="subnav">
  <tr>
      <td class="small" colspan='4'>
          <a href="../history/history.php" class="css_button" onclick='top.restoreSession()'>
          ...
          <a href="../report/patient_report.php" class="css_button" onclick='top.restoreSession()'>
          ...
          <a href="../../../controller.php?document&list&patient_id=<?php echo $pid;?>" class="css_button" onclick='top.restoreSession()'>
            <?php echo htmlspecialchars(xl('Documents'), ENT_NOQUOTES); ?></a>
                    <a href="../transaction/transactions.php" class="css_button" onclick='top.restoreSession()'>
            <?php echo htmlspecialchars(xl('Transactions'), ENT_NOQUOTES); ?></a>
                    <a href="stats_full.php?active=all" class="css_button" onclick='top.restoreSession()'>
            <?php echo htmlspecialchars(xl('Issues'), ENT_NOQUOTES); ?></a>
                    <a href="../../reports/pat_ledger.php?form=1&patient_id=<?php echo attr($pid);?>" class="css_button" onclick='top.restoreSession()'>
            <?php echo xlt('Ledger'); ?></a>
          
          <a href="../../reports/external_data.php" class="css_button" onclick='top.restoreSession()'>
            <?php echo xlt('External Data'); ?></a>
                   <a href="../webcam/index.php" onclick='top.restoreSession()' class="css_button">
    <?php echo xlt('Take Picture'); ?></a>
...
if ($result3['provider']) {   // Use provider in case there is an ins record w/ unassigned insco
    ...
    xlt('Primary Agent') . ': ' . text($insco_name) .
    "</span>&nbsp;&nbsp;&nbsp;";
    if ($result3['copay'] > 0) {
                                ...
                                <tr>
                                 <td valign='top' colspan='3'>
                                  <span class='text'>
                                    ...
                                    echo htmlspecialchars(xl($tempinstype.' Agent'), ENT_NOQUOTES); ?>
...
<img src="<?php echo $imageurl;?> "class="avatar" style="width:9em;height:10em;border-radius:5% ;">
